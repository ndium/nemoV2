...
class DRLEnvironment(Node):
    def __init__(self):
        ...
        ************************************************************"""
        ...
        # publishers
        self.cmd_vel_pub = self.create_publisher(Twist, self.velo_topic, reliable_qos)
        # subscribers
        ...
        self.clock_sub = self.create_subscription(Clock, '/clock', self.clock_callback, best_effort_qos)
